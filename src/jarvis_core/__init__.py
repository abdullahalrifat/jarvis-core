...
__all__ = [
    ...
    "TaskAnalysis", "adaptive_plan", "route_roles", "stable_cache_key",
]
...
__all__ += [
    "ExecutionProofLedger", "ExecutionState", "LeaseToken", "PermissionAction",
    "PermissionDecision", "PermissionRule", "AutonomousProofKind", "ProofRecord",
